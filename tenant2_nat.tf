...
resource "aviatrix_gateway_snat" "aws_tenant_2_snatgw" {
  ...
  depends_on = [module.aws_tenant_2, module.tenant_2_onprem_vpc, module.tenant_2_onprem_csr]
}
...
resource "aviatrix_gateway_snat" "aws_tenant_2_snathagw" {
  ...
  depends_on = [module.aws_tenant_2, module.tenant_2_onprem_vpc, module.tenant_2_onprem_csr, aviatrix_gateway_snat.aws_tenant_2_snatgw]
}
